...
export const ipoData: IPO[] = [
  {
    ...
    gmp: 68,
    gmpPercent: 15.3,
    openDate: '20 Feb 2026',
    closeDate: '24 Feb 2026',
    listingDate: '28 Feb 2026',
    subscriptionStatus: '24.8x',
    qib: '42.6x',
    nii: '28.4x',
    rii: '14.2x',
    totalSubscription: '24.8x',
    lotSize: 33,
    minAmount: 14685,
    issueSize: '₹1,240 Cr',
    sector: 'SaaS / Cloud',
  ...
  },
  {
    ...
    listingDate: '3 Mar 2026',
    subscriptionStatus: '12.4x',
    qib: '18.2x',
    nii: '14.6x',
    rii: '8.4x',
    totalSubscription: '12.4x',
    lotSize: 50,
    minAmount: 14750,
    issueSize: '₹860 Cr',
  ...
  },
  {
    ...
    closeDate: '18 Feb 2026',
    listingDate: '24 Feb 2026',
    subscriptionStatus: '3.2x',
    qib: '2.8x',
    nii: '4.1x',
    rii: '2.4x',
    totalSubscription: '3.2x',
    lotSize: 76,
    minAmount: 14820,
    issueSize: '₹2,100 Cr',
    sector: 'E-Commerce',
    prediction: 'AVOID',
    predictionReason: 'Negative GMP indicates weak demand. Company has been loss-making for 5 consecutive years. High competition from Swiggy/Zomato/Blinkit. Avoid.',
    rating: 2,
    status: 'CLOSED',
  },
  {
